        ...
        <header class="dashboard-header">
            ...
            <div style="display: flex; align-items: center; gap: 12px;">
                ...
                <button type="button" id="themeToggleBtn" class="theme-toggle-btn" aria-label="Toggle Theme">
                    <svg id="themeIconSun" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="display: none;">
                    ...
                    <svg id="themeIconMoon" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
