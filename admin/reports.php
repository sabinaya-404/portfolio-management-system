...
<section class="summary-grid" aria-label="Current database totals">
    ...
    <div class="summary-card"><span>TOTAL PROFIT/LOSS</span><strong><?= ($summary["total_profit_loss"] ?? 0) >= 0 ? '+' : '' ?>Rs. <?= number_format((float) ($summary["total_profit_loss"] ?? 0), 2) ?></strong><small>Based on purchase vs current prices</small></div>
</section>
